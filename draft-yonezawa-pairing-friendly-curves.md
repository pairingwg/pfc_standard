...
BN curves always have order 6 twists. If m is an element which is neither a square nor a cube in a finite field F\_p2, the twisted curve E' of E is defined over a finite field F\_p2 by the equation E': y^2 = x^3 + b' with b' = b / m or b' = b \* m. 
...
A pairing e is defined by taking G\_1 as ..., G\_2 as ..., and G\_T as ... .
...
- G\_2 defined over E': y^2 = x^3 + b'
    - r' : an order (should be modified)
    - BP' = (x', y') : a base point
        - x' = x'1 * u + x'2 (x'1, x'2 in F\_p) (should be modified)
        - y' = y'1 * u + y'2 (y'1, y'2 in F\_p) (should be modified)
    - h' : a cofactor
    - b' : a coefficient of E'
